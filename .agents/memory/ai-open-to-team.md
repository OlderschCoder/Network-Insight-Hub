...
**Why:** Owner (CIO Dr. Bojeun) explicitly overrode a code-review recommendation to role-gate diagnostics, saying "anyone talking to AI works for me... this is for the 8 team members who need to know how someone else solved the same issue." Small, fully-trusted internal team; the owner prioritizes frictionless team knowledge-sharing over least-privilege. Recurring theme in his requests: "loosen the chains" / make the AI more helpful and agentic.
