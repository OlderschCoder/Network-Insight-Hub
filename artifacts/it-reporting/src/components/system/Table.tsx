...
>(({ className, ...props }, ref) => (
  <div className="w-full overflow-x-auto rounded-brand border border-line">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-paper", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn("transition-colors hover:bg-paper/60", className)}
    {...props}
  />
));
