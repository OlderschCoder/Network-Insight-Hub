...
**Navigation:** Prefer **`NETWORK_OVERVIEW.md`** as canonical; see **`INDEX.md`** for the full documentation map.

**All buildings / master index:** **`SCCC_NETWORK_OVERVIEW_ALL_BUILDINGS.md`**. **On-prem ports/OSPF:** **`BUILDING_SWITCH_TOPOLOGY.md`**.
