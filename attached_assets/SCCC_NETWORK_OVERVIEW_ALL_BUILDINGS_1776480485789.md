...
| Need | Use sections |
|------|----------------|
| **Executive / campus map** | **§1** (buildings), **§5** Mermaid (high-level paths) |
...
| **Cloud / hybrid overlay** | **§4** here + **`NETWORK_OVERVIEW.md`** §4 + **`azure-export-*`** (`20-*` VNets, `27–29` VPN, `40/50` VMs) |
