...
**Purpose:** Operational list of **buildings / devices**, **reachability status**, and **IP** (management **192.168.2.x** where noted, or **SVI**). Aligns with configs in this repo where filenames match site codes. Use for **diagram labels**, **monitoring**, and **lifecycle / strategic** reviews (gaps in **Status**).

**Documentation index:** **`INDEX.md`**.  
**Downlinks + OSPF + port mapping:** **`BUILDING_SWITCH_TOPOLOGY.md`** (Nexus **a48/a24** ports, OSPF **Vlan611–628**, hostname ↔ file ↔ building).
